...
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/iamriajul/adhan-dart/tests.yml?branch=main)](https://github.com/iamriajul/adhan-dart/actions?query=branch:v2)
